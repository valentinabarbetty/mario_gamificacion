...
from ..components.popup_text import PopupText
...
class Level1(tools._State):
    ...
    def update(self, surface, keys, current_time):
        ...
        # --- SIEMPRE MOSTRAR POPUP AL FINAL ---
    ...
    def handle_states(self, keys):
        ...
        # --- 1. POPUP ACTIVO → CONGELA TODO EL JUEGO ---
        if const.POPUP_ACTIVE:
            print("⏸️ JUEGO CONGELADO, ESPERANDO X")

            # Mostrar el popup si hay texto pendiente
    ...
    def update_all_sprites(self, keys):
        ...
        # Si el popup está activo, no actualizar nada
        if const.POPUP_ACTIVE:
            print("🔔 POPUP ACTIVO (update_all_sprites) — NO ACTUALIZANDO SPRITES")
            return

        # --- ACTUALIZACIÓN NORMAL DE SPRITES ---
        self.mario.update(keys, self.game_info, self.powerup_group)
